...
def steward(config_file_path:str, ukb_gatk4_base_quality_score_recalibrator_path:str, send_message_script:str) -> None:
    ...
    with open('ukb_gatk4_base_quality_score_recalibrator_command.txt', 'w') as command_f:
        command_f.write(ukb_gatk4_base_quality_score_recalibrator_command + '\n')
    ...
    feedback_dict = {
        ...
        'pipelineName'    : 'ukb_gatk4_base_quality_score_recalibrator',
        'analysisStatus'  : '',
